...
\begin{todolist}
    ...
    \item[] Implement a mono-energetic proof of concept of discritization schems in both Source itterations and One-cell inversions in a Python code for both CPUs and GPUs
    ...
    \item[] Implement discretization scheme in both a Source iteration and One-cell inversion iterative scheme performantly on GPUs and meausre wall clock runtime
